...
Column {
    ...
    Row {
        ...
        Rectangle {
            ...
            radius: 20
            clip: true
            color: Qt.darker(page.accent, 1.7)

            Rectangle {
                anchors.fill: parent
                radius: weatherCard.radius
                gradient: Gradient {
                    GradientStop { position: 0.0; color: Qt.rgba(page.accent.r, page.accent.g, page.accent.b, 0.42) }
            ...
            Pill.GlyphIcon {
                ...
                color: Qt.rgba(page.ink.r, page.ink.g, page.ink.b, 0.16)
            }
